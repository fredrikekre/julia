...
@test_throws DomainError Base.dSFMT.DSFMT_state(fill(Int32(0), rand(0:Base.dSFMT.JN32-1)))

@test_throws DomainError MersenneTwister(fill(UInt32(0), 1), Base.dSFMT.DSFMT_state(),
                                         fill(0.0, 10), fill(UInt128(0), MT_CACHE_I>>4), 0, 0)

@test_throws DomainError MersenneTwister(fill(UInt32(0), 1), Base.dSFMT.DSFMT_state(),
                                         fill(0.0, MT_CACHE_F), fill(UInt128(0), MT_CACHE_I>>4), -1, 0)

@test_throws DomainError MersenneTwister(fill(UInt32(0), 1), Base.dSFMT.DSFMT_state(),
                                         fill(0.0, MT_CACHE_F), fill(UInt128(0), MT_CACHE_I>>3), 0, 0)

@test_throws DomainError MersenneTwister(fill(UInt32(0), 1), Base.dSFMT.DSFMT_state(),
                                         fill(0.0, MT_CACHE_F), fill(UInt128(0), MT_CACHE_I>>4), 0, -1)
